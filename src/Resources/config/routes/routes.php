...
return static function (RoutingConfigurator $routes) {
    $routes
        ...
        ->methods(['GET'])->requirements(['fileId' => '[[:alnum:]]+'])
        ->requirements(['fileId' => '[[:alnum:]]+'])
        ->condition('request.query.has("access_token") === true');
    ...
    $routes
        ...
        ->methods(['POST'])
        ->requirements(['fileId' => '[[:alnum:]]+'])
        ->condition('request.headers.get("X-WOPI-Override") === "PUT" and request.headers.get("X-WOPI-Lock") !== null and request.headers.get("X-WOPI-Editors") !== null');
